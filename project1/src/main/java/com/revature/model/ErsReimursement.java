...
public class ErsReimursement {
	...
	public ErsReimursement() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ErsReimursement(int reimbId, double reimbAmount, Timestamp reimbSubmitted, Timestamp reimbResolved,
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof ErsReimursement))
			return false;
		ErsReimursement other = (ErsReimursement) obj;
